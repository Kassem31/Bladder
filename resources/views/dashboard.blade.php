...
@section('content')
    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-12">
                <div class="alert bg-light-primary welcome-container">
                    <div class="d-flex align-items-center justify-content-center flex-wrap text-center" style="width: 100%;">
                        <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 26 26" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            class="feather feather-smile me-2">
                ...
                <style>
                    /* Ensure welcome message is perfectly centered */
                    .welcome-container {
                        display: flex;
                    ...
                    @media (max-width: 576px) {
                        .welcome-container .feather-smile {
