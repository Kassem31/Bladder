...
@section('title', 'Create Dismount Transaction')

@section('content')
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="page-title">
                <h3>Create Dismount Transaction</h3>
            </div>
                    ...
                    <div class="card-body p-5">
                        <hr>
                            ...
                            <form action="{{ route('bladder-transactions.store') }}" method="POST" class="row g-3">
                                @csrf
                                <input type="hidden" name="TransactionType" value="Dismount">

                                <div class="col-md-6"> <label for="BladderId" class="form-label">Bladder *</label>
                                    ...
                                    @enderror
                                </div> <!-- Machine and Discriminator are hidden for Dismount transactions -->
                                <input type="hidden" name="MachineId" value="">
                                <input type="hidden" name="Discriminator" value="Dismount Transaction">
