<div class="icon-select-dropdown" id="iconSelectDropdown">
    ...
    <div class="icon-grid-container" id="iconGridContainer">
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-0-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-0-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-0-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-0-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-1-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-1-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-1-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-1-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-2-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-2-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-2-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-3-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-3-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-3-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-3-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-4-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-4-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-4-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-4-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-5-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-5-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-5-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-5-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-6-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-6-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-6-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-6-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-7-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-7-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-7-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-7-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-8-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-8-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-8-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-8-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-9-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-9-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-9-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-9-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-activity' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-airplane' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-airplane-engines' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-airplane-engines-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-airplane-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-alarm' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-alarm-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-alexa' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-align-bottom' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-align-center' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-align-end' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-align-middle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-align-start' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-align-top' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-alipay' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-alphabet' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-alphabet-uppercase' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-android2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-anthropic' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-apple' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-apple-music' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-archive' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-archive-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-90deg-down' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-90deg-left' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-90deg-right' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-90deg-up' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-bar-down' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-bar-left' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-bar-right' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-bar-up' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-clockwise' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-counterclockwise' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-down' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-down-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-down-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-down-left' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-down-left-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-down-left-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-down-left-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-down-left-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-down-right' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-down-right-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-down-right-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-down-right-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-down-right-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-down-short' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-down-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-down-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-down-up' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-left' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-left-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-left-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-left-right' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-left-short' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-left-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-left-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-repeat' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-return-left' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-return-right' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-right' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-right-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-right-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-right-short' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-right-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-right-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-through-heart' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-through-heart-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-up' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-up-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-up-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-up-left' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-up-left-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-up-left-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-up-left-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-up-left-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-up-right' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-up-right-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-up-right-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-up-right-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-up-right-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-up-short' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-up-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrow-up-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrows' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrows-angle-contract' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrows-angle-expand' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrows-collapse' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrows-collapse-vertical' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrows-expand' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrows-expand-vertical' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrows-fullscreen' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrows-move' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-arrows-vertical' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-aspect-ratio' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-aspect-ratio-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-asterisk' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-award-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-back' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-backpack' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-backpack-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-backpack2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-backpack2-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-backpack3' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-backpack3-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-backpack4' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-backpack4-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-backspace' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-backspace-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-backspace-reverse' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-backspace-reverse-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-badge-3d' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-badge-3d-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-badge-4k' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-badge-4k-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-badge-8k' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-badge-8k-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-badge-ad' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-badge-ad-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-badge-ar' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-badge-ar-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-badge-cc' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-badge-cc-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-badge-hd' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-badge-hd-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-badge-sd' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-badge-sd-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-badge-tm' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-badge-tm-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-badge-vo' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-badge-vo-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-badge-vr' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-badge-vr-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-badge-wc' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-badge-wc-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bag-check-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bag-dash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bag-dash-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bag-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bag-heart' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bag-heart-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bag-plus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bag-plus-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bag-x' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bag-x-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-balloon' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-balloon-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-balloon-heart' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-balloon-heart-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bandaid' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bandaid-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bank' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bank2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bar-chart' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bar-chart-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bar-chart-line' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bar-chart-line-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bar-chart-steps' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-basket' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-basket-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-basket2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-basket2-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-basket3' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-basket3-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-battery' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-battery-charging' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-battery-full' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-battery-half' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-battery-low' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-beaker' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-beaker-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-behance' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bell' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bell-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bell-slash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bell-slash-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bezier' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bezier2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bicycle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bing' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-binoculars' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-binoculars-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-blockquote-left' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-blockquote-right' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bluesky' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bluetooth' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-body-text' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-book' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-book-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-book-half' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bookmark' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bookmark-check' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bookmark-check-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bookmark-dash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bookmark-dash-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bookmark-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bookmark-heart' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bookmark-heart-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bookmark-plus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bookmark-plus-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bookmark-star' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bookmark-star-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bookmark-x' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bookmark-x-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bookmarks' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bookmarks-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bookshelf' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-boombox' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-boombox-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bootstrap' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bootstrap-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bootstrap-reboot' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-border' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-border-all' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-border-bottom' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-border-center' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-border-inner' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-border-left' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-border-middle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-border-outer' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-border-right' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-border-style' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-border-top' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-border-width' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bounding-box' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bounding-box-circles' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-box-arrow-down-left' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-box-arrow-down-right' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-box-arrow-in-down' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-box-arrow-in-down-left' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-box-arrow-in-down-right' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-box-arrow-in-left' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-box-arrow-in-right' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-box-arrow-in-up' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-box-arrow-in-up-left' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-box-arrow-in-up-right' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-box-arrow-left' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-box-arrow-right' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-box-arrow-up' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-box-arrow-up-left' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-box-arrow-up-right' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-box-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-box-seam' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-box-seam-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-box2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-box2-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-box2-heart' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-box2-heart-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-boxes' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-braces' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-braces-asterisk' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bricks' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-briefcase' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-briefcase-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-brightness-alt-high' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-brightness-alt-high-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-brightness-alt-low' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-brightness-alt-low-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-brightness-high' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-brightness-high-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-brightness-low' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-brightness-low-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-brilliance' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-broadcast' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-broadcast-pin' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-browser-chrome' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-browser-edge' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-browser-firefox' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-browser-safari' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-brush' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-brush-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bucket' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bucket-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-building' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-building-add' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-building-check' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-building-dash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-building-down' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-building-exclamation' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-building-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-building-fill-add' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-building-fill-check' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-building-fill-dash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-building-fill-down' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-building-fill-exclamation' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-building-fill-gear' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-building-fill-lock' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-building-fill-slash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-building-fill-up' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-building-fill-x' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-building-gear' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-building-lock' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-building-slash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-building-up' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-building-x' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-buildings' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-buildings-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bullseye' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bus-front' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-bus-front-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-c-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-c-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-c-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-c-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cake' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cake-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cake2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cake2-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calculator' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calculator-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar-check' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar-check-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar-date' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar-date-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar-day' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar-day-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar-event' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar-event-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar-heart' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar-heart-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar-minus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar-minus-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar-month' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar-month-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar-plus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar-plus-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar-range' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar-range-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar-week' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar-week-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar-x' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar-x-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar2-check' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar2-check-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar2-date' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar2-date-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar2-day' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar2-day-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar2-event' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar2-event-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar2-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar2-heart' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar2-heart-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar2-minus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar2-minus-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar2-month' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar2-month-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar2-plus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar2-plus-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar2-range' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar2-range-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar2-week' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar2-week-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar2-x' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar2-x-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar3' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar3-event' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar3-event-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar3-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar3-range' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar3-range-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar3-week' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar3-week-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar4' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar4-event' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar4-range' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-calendar4-week' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-camera' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-camera-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-camera-reels' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-camera-reels-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-camera-video' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-camera-video-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-camera-video-off' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-camera-video-off-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-camera2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-capslock' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-capslock-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-capsule' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-capsule-pill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-car-front' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-car-front-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-card-checklist' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-card-heading' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-card-image' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-card-list' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-card-text' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-caret-down' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-caret-down-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-caret-down-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-caret-down-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-caret-left' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-caret-left-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-caret-left-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-caret-left-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-caret-right' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-caret-right-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-caret-right-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-caret-right-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-caret-up' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-caret-up-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-caret-up-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-caret-up-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cart' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cart-check' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cart-check-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cart-dash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cart-dash-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cart-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cart-plus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cart-plus-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cart-x' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cart-x-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cart2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cart3' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cart4' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cash-coin' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cash-stack' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cassette' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cassette-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cast' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cc-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cc-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cc-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cc-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-dots' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-dots-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-heart' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-heart-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-left' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-left-dots' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-left-dots-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-left-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-left-heart' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-left-heart-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-left-quote' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-left-quote-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-left-text' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-left-text-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-quote' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-quote-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-right' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-right-dots' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-right-dots-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-right-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-right-heart' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-right-heart-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-right-quote' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-right-quote-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-right-text' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-right-text-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-square-dots' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-square-dots-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-square-heart' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-square-heart-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-square-quote' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-square-quote-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-square-text' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-square-text-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-text' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chat-text-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-check' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-check-all' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-check-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-check-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-check-lg' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-check-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-check-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-check2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-check2-all' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-check2-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-check2-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chevron-bar-contract' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chevron-bar-down' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chevron-bar-expand' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chevron-bar-left' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chevron-bar-right' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chevron-bar-up' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chevron-compact-down' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chevron-compact-left' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chevron-compact-right' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chevron-compact-up' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chevron-contract' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chevron-double-down' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chevron-double-left' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chevron-double-right' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chevron-double-up' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chevron-down' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chevron-expand' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chevron-left' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chevron-right' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-chevron-up' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-circle-half' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-circle-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-claude' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clipboard' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clipboard-check' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clipboard-check-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clipboard-data' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clipboard-data-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clipboard-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clipboard-heart' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clipboard-heart-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clipboard-minus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clipboard-minus-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clipboard-plus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clipboard-plus-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clipboard-pulse' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clipboard-x' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clipboard-x-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clipboard2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clipboard2-check' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clipboard2-check-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clipboard2-data' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clipboard2-data-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clipboard2-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clipboard2-heart' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clipboard2-heart-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clipboard2-minus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clipboard2-minus-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clipboard2-plus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clipboard2-plus-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clipboard2-pulse' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clipboard2-pulse-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clipboard2-x' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clipboard2-x-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clock' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clock-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clock-history' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-arrow-down' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-arrow-down-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-arrow-up' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-arrow-up-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-check' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-check-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-download' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-download-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-drizzle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-drizzle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-fog' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-fog-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-fog2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-fog2-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-hail' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-hail-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-haze' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-haze-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-haze2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-haze2-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-lightning' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-lightning-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-lightning-rain' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-lightning-rain-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-minus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-minus-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-moon' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-moon-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-plus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-plus-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-rain' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-rain-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-rain-heavy' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-rain-heavy-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-slash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-slash-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-sleet' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-sleet-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-snow' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-snow-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-sun' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-sun-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-upload' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloud-upload-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clouds' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-clouds-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloudy' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cloudy-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-code' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-code-slash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-code-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-coin' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-collection' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-collection-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-collection-play' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-collection-play-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-columns' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-columns-gap' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-command' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-compass' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-compass-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cone' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cone-striped' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-controller' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cookie' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-copy' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-credit-card' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-credit-card-2-back' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-credit-card-2-back-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-credit-card-2-front' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-credit-card-2-front-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-credit-card-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-crop' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-crosshair' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-crosshair2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cup-hot' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cup-hot-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cup-straw' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-currency-bitcoin' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-currency-dollar' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-currency-euro' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-currency-exchange' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-currency-pound' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-currency-rupee' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-currency-yen' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cursor' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cursor-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-cursor-text' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-dash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-dash-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-dash-circle-dotted' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-dash-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-dash-lg' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-dash-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-dash-square-dotted' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-dash-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-database' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-database-add' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-database-check' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-database-dash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-database-down' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-database-exclamation' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-database-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-database-fill-add' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-database-fill-check' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-database-fill-dash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-database-fill-down' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-database-fill-exclamation' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-database-fill-gear' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-database-fill-lock' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-database-fill-slash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-database-fill-up' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-database-fill-x' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-database-gear' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-database-lock' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-database-slash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-database-up' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-database-x' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-device-hdd' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-device-hdd-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-device-ssd' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-device-ssd-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-diagram-2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-diagram-2-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-diagram-3' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-diagram-3-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-diamond' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-diamond-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-diamond-half' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-dice-1' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-dice-1-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-dice-2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-dice-2-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-dice-3' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-dice-3-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-dice-4' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-dice-4-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-dice-5' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-dice-5-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-dice-6' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-dice-6-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-disc' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-disc-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-discord' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-display' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-display-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-displayport' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-displayport-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-distribute-horizontal' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-distribute-vertical' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-door-closed' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-door-closed-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-door-open' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-door-open-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-dpad' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-dpad-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-dribbble' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-dropbox' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-droplet' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-droplet-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-droplet-half' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-duffle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-duffle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-earbuds' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-easel' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-easel-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-easel2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-easel2-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-easel3' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-easel3-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-egg-fried' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-eject' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-eject-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-angry' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-angry-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-astonished' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-astonished-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-dizzy' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-dizzy-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-expressionless' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-expressionless-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-frown' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-frown-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-grimace' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-grimace-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-grin' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-grin-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-heart-eyes' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-heart-eyes-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-kiss' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-kiss-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-laughing' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-laughing-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-neutral' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-neutral-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-smile' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-smile-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-smile-upside-down' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-smile-upside-down-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-sunglasses' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-sunglasses-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-surprise' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-surprise-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-tear' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-tear-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-wink' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-emoji-wink-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-envelope' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-envelope-arrow-down' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-envelope-arrow-down-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-envelope-arrow-up' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-envelope-arrow-up-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-envelope-at' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-envelope-at-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-envelope-check' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-envelope-check-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-envelope-dash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-envelope-dash-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-envelope-exclamation' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-envelope-exclamation-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-envelope-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-envelope-heart' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-envelope-heart-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-envelope-open' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-envelope-open-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-envelope-open-heart' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-envelope-open-heart-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-envelope-paper' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-envelope-paper-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-envelope-paper-heart' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-envelope-paper-heart-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-envelope-plus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-envelope-plus-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-envelope-slash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-envelope-slash-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-envelope-x' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-envelope-x-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-eraser' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-eraser-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-escape' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-ethernet' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-ev-front' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-ev-front-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-ev-station' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-ev-station-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-exclamation' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-exclamation-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-exclamation-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-exclamation-diamond' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-exclamation-diamond-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-exclamation-lg' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-exclamation-octagon' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-exclamation-octagon-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-exclamation-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-exclamation-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-exclamation-triangle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-exclamation-triangle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-exclude' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-explicit' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-explicit-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-exposure' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-eye-slash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-eye-slash-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-eyedropper' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-eyeglasses' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-fast-forward-btn' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-fast-forward-btn-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-fast-forward-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-fast-forward-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-fast-forward-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-feather' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-feather2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-arrow-down' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-arrow-down-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-arrow-up' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-arrow-up-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-bar-graph' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-bar-graph-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-binary' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-binary-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-break' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-break-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-check' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-check-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-code' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-code-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-diff' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-diff-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-arrow-down' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-arrow-down-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-arrow-up' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-arrow-up-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-bar-graph' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-bar-graph-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-binary' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-binary-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-break' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-break-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-check' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-check-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-code' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-code-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-diff' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-diff-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-easel' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-easel-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-excel' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-excel-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-font' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-font-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-image' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-image-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-lock' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-lock-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-lock2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-lock2-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-medical' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-medical-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-minus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-minus-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-music' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-music-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-pdf' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-pdf-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-person' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-person-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-play' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-play-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-plus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-plus-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-post' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-post-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-ppt' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-ppt-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-richtext' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-richtext-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-ruled' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-ruled-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-slides' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-slides-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-spreadsheet' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-spreadsheet-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-text' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-text-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-word' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-word-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-x' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-x-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-zip' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-earmark-zip-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-easel' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-easel-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-excel' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-excel-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-font' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-font-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-image' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-image-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-lock' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-lock-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-lock2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-lock2-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-medical' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-medical-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-minus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-minus-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-music' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-music-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-pdf' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-pdf-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-person' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-person-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-play' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-play-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-plus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-plus-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-post' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-post-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-ppt' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-ppt-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-richtext' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-richtext-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-ruled' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-ruled-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-slides' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-slides-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-spreadsheet' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-spreadsheet-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-text' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-text-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-word' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-word-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-x' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-x-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-zip' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-file-zip-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-files' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-files-alt' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-aac' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-ai' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-bmp' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-cs' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-css' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-csv' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-doc' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-docx' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-exe' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-gif' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-heic' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-html' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-java' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-jpg' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-js' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-json' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-jsx' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-key' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-m4p' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-md' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-mdx' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-mov' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-mp3' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-mp4' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-otf' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-pdf' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-php' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-png' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-ppt' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-pptx' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-psd' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-py' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-raw' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-rb' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-sass' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-scss' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-sh' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-sql' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-svg' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-tiff' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-tsx' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-ttf' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-txt' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-wav' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-woff' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-xls' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-xlsx' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-xml' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filetype-yml' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-film' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filter' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filter-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filter-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filter-left' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filter-right' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filter-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-filter-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-fingerprint' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-fire' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-flag' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-flag-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-flask' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-flask-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-flask-florence' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-flask-florence-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-floppy' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-floppy-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-floppy2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-floppy2-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-flower1' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-flower2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-flower3' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-folder' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-folder-check' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-folder-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-folder-minus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-folder-plus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-folder-symlink' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-folder-symlink-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-folder-x' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-folder2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-folder2-open' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-fonts' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-fork-knife' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-forward' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-forward-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-front' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-fuel-pump' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-fuel-pump-diesel' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-fuel-pump-diesel-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-fuel-pump-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-fullscreen' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-fullscreen-exit' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-funnel' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-funnel-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-gear' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-gear-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-gear-wide' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-gear-wide-connected' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-gem' ? 'selected' : '' }}"
             data-value="bi bi-gem" data-search="gem">
            <i class="bi bi-gem" style="font-size: 1.2rem; color: #0d6efd;"></i>
            <span class="icon-name">gem</span>
        </div>
        <div class="icon-option {{ old('IconClass') == 'bi bi-gender-ambiguous' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-gender-female' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-gender-male' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-gender-neuter' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-gender-trans' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-geo-alt-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-geo-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-gift' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-gift-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-gitlab' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-globe' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-globe-americas' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-globe-americas-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-globe-asia-australia' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-globe-asia-australia-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-globe-central-south-asia' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-globe-central-south-asia-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-globe-europe-africa' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-globe-europe-africa-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-globe2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-google' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-google-play' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-gpu-card' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-graph-down' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-graph-down-arrow' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-graph-up' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-graph-up-arrow' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-grid' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-grid-1x2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-grid-1x2-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-grid-3x2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-grid-3x2-gap' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-grid-3x2-gap-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-grid-3x3' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-grid-3x3-gap' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-grid-3x3-gap-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-grid-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-grip-horizontal' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-grip-vertical' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-h-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-h-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-h-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-h-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-hammer' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-hand-index' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-hand-index-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-hand-index-thumb' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-hand-index-thumb-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-hand-thumbs-down' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-hand-thumbs-down-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-hand-thumbs-up' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-hand-thumbs-up-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-handbag' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-handbag-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-hash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-hdd-network' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-hdd-network-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-hdd-rack' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-hdd-rack-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-hdd-stack' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-hdd-stack-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-hdmi' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-hdmi-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-headphones' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-headset' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-headset-vr' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-heart' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-heart-arrow' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-heart-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-heart-half' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-heart-pulse' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-heart-pulse-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-heartbreak' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-heartbreak-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-hearts' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-heptagon' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-heptagon-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-heptagon-half' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-hexagon' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-hexagon-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-hexagon-half' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-highlighter' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-highlights' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-hospital' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-hospital-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-hourglass' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-hourglass-bottom' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-hourglass-split' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-hourglass-top' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-house' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-house-add' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-house-add-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-house-check' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-house-check-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-house-dash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-house-dash-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-house-door' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-house-door-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-house-down' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-house-down-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-house-exclamation' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-house-exclamation-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-house-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-house-gear' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-house-gear-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-house-heart' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-house-heart-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-house-lock' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-house-lock-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-house-slash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-house-slash-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-house-up' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-house-up-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-house-x' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-house-x-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-houses' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-houses-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-hypnotize' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-image' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-image-alt' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-image-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-images' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-inbox' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-inbox-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-inboxes' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-inboxes-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-incognito' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-indent' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-infinity' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-info' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-info-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-info-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-info-lg' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-info-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-info-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-input-cursor' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-input-cursor-text' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-instagram' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-intersect' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-javascript' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-journal' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-journal-album' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-journal-arrow-down' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-journal-arrow-up' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-journal-bookmark' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-journal-bookmark-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-journal-check' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-journal-code' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-journal-medical' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-journal-minus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-journal-plus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-journal-richtext' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-journal-text' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-journal-x' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-journals' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-joystick' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-justify' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-justify-left' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-justify-right' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-kanban' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-kanban-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-keyboard' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-keyboard-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-ladder' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-lamp' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-lamp-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-laptop' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-laptop-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-layer-backward' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-layer-forward' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-layers' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-layers-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-layers-half' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-layout-sidebar' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-layout-sidebar-inset' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-layout-sidebar-inset-reverse' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-layout-sidebar-reverse' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-layout-split' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-layout-text-sidebar' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-layout-text-sidebar-reverse' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-layout-text-window' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-layout-text-window-reverse' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-layout-three-columns' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-layout-wtf' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-leaf' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-leaf-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-life-preserver' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-lightbulb' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-lightbulb-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-lightbulb-off' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-lightbulb-off-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-lightning' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-lightning-charge' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-lightning-charge-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-lightning-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-line' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-link' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-link-45deg' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-linkedin' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-list' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-list-check' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-list-columns' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-list-columns-reverse' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-list-nested' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-list-ol' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-list-stars' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-list-task' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-list-ul' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-lock' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-lock-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-luggage' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-luggage-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-lungs' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-lungs-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-magic' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-magnet' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-magnet-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-mailbox' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-mailbox-flag' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-mailbox2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-mailbox2-flag' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-markdown' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-markdown-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-marker-tip' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-mask' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-mastodon' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-measuring-cup' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-measuring-cup-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-medium' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-megaphone' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-megaphone-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-memory' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-menu-app' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-menu-app-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-menu-button' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-menu-button-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-menu-button-wide' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-menu-button-wide-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-menu-down' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-menu-up' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-messenger' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-meta' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-mic-mute' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-mic-mute-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-microsoft' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-microsoft-teams' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-minecart' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-minecart-loaded' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-modem' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-modem-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-moisture' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-moon' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-moon-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-moon-stars' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-moon-stars-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-mortarboard' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-mortarboard-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-motherboard' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-motherboard-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-mouse' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-mouse-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-mouse2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-mouse2-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-mouse3' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-mouse3-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-music-note' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-music-note-beamed' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-music-note-list' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-music-player' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-music-player-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-newspaper' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-nintendo-switch' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-node-minus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-node-minus-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-node-plus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-node-plus-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-noise-reduction' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-nvidia' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-nvme' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-nvme-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-octagon' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-octagon-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-octagon-half' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-openai' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-opencollective' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-optical-audio' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-optical-audio-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-option' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-outlet' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-p-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-p-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-p-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-p-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-paint-bucket' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-palette' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-palette-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-palette2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-paperclip' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-paragraph' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-pass' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-pass-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-passport' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-passport-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-patch-check' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-patch-check-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-patch-exclamation' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-patch-exclamation-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-patch-minus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-patch-minus-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-patch-plus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-patch-plus-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-patch-question' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-patch-question-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-pause' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-pause-btn' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-pause-btn-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-pause-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-pause-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-pause-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-paypal' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-pc-display-horizontal' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-pc-horizontal' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-pci-card' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-pci-card-network' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-pci-card-sound' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-peace' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-peace-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-pencil' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-pencil-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-pencil-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-pentagon' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-pentagon-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-pentagon-half' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-people' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-people-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-percent' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-perplexity' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-add' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-arms-up' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-badge' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-badge-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-bounding-box' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-check' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-check-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-dash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-dash-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-down' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-exclamation' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-fill-add' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-fill-check' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-fill-dash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-fill-down' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-fill-exclamation' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-fill-gear' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-fill-lock' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-fill-slash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-fill-up' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-fill-x' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-gear' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-heart' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-hearts' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-lines-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-lock' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-plus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-plus-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-raised-hand' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-rolodex' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-slash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-standing' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-standing-dress' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-up' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-vcard' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-vcard-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-video' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-video2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-video3' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-walking' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-wheelchair' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-workspace' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-x' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-person-x-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-phone' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-phone-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-phone-flip' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-phone-landscape' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-phone-landscape-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-phone-vibrate' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-phone-vibrate-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-pie-chart' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-pie-chart-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-piggy-bank' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-piggy-bank-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-pin-angle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-pin-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-pin-map' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-pin-map-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-pinterest' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-play' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-play-btn' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-play-btn-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-play-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-play-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-play-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-playstation' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-plug' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-plug-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-plugin' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-plus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-plus-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-plus-circle-dotted' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-plus-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-plus-lg' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-plus-slash-minus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-plus-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-plus-square-dotted' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-plus-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-postage' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-postage-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-postage-heart' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-postage-heart-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-postcard' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-postcard-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-postcard-heart' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-postcard-heart-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-power' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-prescription' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-prescription2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-printer' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-printer-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-projector' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-projector-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-puzzle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-puzzle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-qr-code' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-qr-code-scan' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-question' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-question-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-question-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-question-diamond' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-question-diamond-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-question-lg' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-question-octagon' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-question-octagon-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-question-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-question-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-quora' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-quote' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-r-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-r-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-r-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-r-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-radar' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-radioactive' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-rainbow' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-receipt' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-receipt-cutoff' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-reception-0' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-reception-1' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-reception-2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-reception-3' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-reception-4' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-record' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-record-btn' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-record-btn-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-record-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-record-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-record-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-record2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-record2-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-recycle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-reddit' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-regex' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-repeat' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-repeat-1' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-reply' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-reply-all' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-reply-all-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-reply-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-rewind' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-rewind-btn' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-rewind-btn-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-rewind-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-rewind-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-rewind-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-robot' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-rocket' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-rocket-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-rocket-takeoff' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-rocket-takeoff-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-router' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-router-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-rulers' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-safe' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-safe-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-safe2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-safe2-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-save' ? 'selected' : '' }}"
             data-value="bi bi-save" data-search="save">
            <i class="bi bi-save" style="font-size: 1.2rem; color: #0d6efd;"></i>
            <span class="icon-name">save</span>
        </div>
        <div class="icon-option {{ old('IconClass') == 'bi bi-save-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-save2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-save2-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-scissors' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-scooter' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-screwdriver' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sd-card' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sd-card-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-search' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-search-heart' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-search-heart-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-segmented-nav' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-send' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-send-arrow-down' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-send-arrow-down-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-send-arrow-up' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-send-arrow-up-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-send-check' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-send-check-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-send-dash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-send-dash-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-send-exclamation' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-send-exclamation-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-send-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-send-plus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-send-plus-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-send-slash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-send-slash-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-send-x' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-send-x-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-server' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-shadows' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-share' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-share-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-shield' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-shield-check' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-shield-exclamation' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-shield-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-shield-fill-check' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-shield-fill-exclamation' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-shield-fill-minus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-shield-fill-plus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-shield-fill-x' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-shield-lock' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-shield-lock-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-shield-minus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-shield-plus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-shield-shaded' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-shield-slash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-shield-slash-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-shield-x' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-shift' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-shift-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-shop' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-shop-window' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-shuffle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-dead-end' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-dead-end-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-do-not-enter' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-do-not-enter-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-intersection' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-intersection-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-intersection-side' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-intersection-side-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-intersection-t' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-intersection-t-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-intersection-y' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-intersection-y-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-merge-left' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-merge-left-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-merge-right' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-merge-right-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-no-left-turn' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-no-left-turn-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-no-parking' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-no-parking-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-no-right-turn' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-no-right-turn-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-railroad' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-railroad-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-stop' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-stop-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-stop-lights' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-stop-lights-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-turn-left' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-turn-left-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-turn-right' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-turn-right-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-turn-slight-left' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-turn-slight-left-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-turn-slight-right' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-turn-slight-right-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-yield' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sign-yield-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-signal' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-signpost' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-signpost-2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-signpost-2-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-signpost-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-signpost-split' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-signpost-split-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sim-slash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sim-slash-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sina-weibo' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-skip-backward' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-skip-backward-btn' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-skip-backward-btn-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-skip-backward-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-skip-backward-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-skip-backward-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-skip-end' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-skip-end-btn' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-skip-end-btn-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-skip-end-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-skip-end-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-skip-end-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-skip-forward' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-skip-forward-btn' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-skip-forward-btn-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-skip-forward-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-skip-forward-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-skip-forward-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-skip-start' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-skip-start-btn' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-skip-start-btn-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-skip-start-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-skip-start-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-skip-start-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-skype' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-slack' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-slash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-slash-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-slash-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-slash-lg' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-slash-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-slash-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sliders' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sliders2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sliders2-vertical' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-smartwatch' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-snapchat' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-snow' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-snow2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-snow3' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sort-alpha-down' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sort-alpha-down-alt' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sort-alpha-up' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sort-alpha-up-alt' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sort-down' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sort-down-alt' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sort-numeric-down' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sort-numeric-down-alt' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sort-numeric-up' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sort-numeric-up-alt' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sort-up' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sort-up-alt' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-soundwave' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sourceforge' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-speaker' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-speaker-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-speedometer' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-speedometer2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-spellcheck' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-spotify' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-square-half' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-stack' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-stack-overflow' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-star' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-star-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-star-half' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-stars' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-steam' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-stickies' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-stickies-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sticky' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sticky-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-stop' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-stop-btn' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-stop-btn-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-stop-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-stop-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-stop-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-stoplights' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-stoplights-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-stopwatch' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-stopwatch-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-strava' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-stripe' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-subscript' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-substack' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-subtract' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-suit-club' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-suit-club-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-suit-diamond' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-suit-diamond-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-suit-heart' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-suit-heart-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-suit-spade' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-suit-spade-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-suitcase' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-suitcase-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-suitcase-lg' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-suitcase-lg-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-suitcase2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-suitcase2-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sunglasses' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sunrise' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sunrise-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sunset' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-sunset-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-superscript' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-symmetry-horizontal' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-symmetry-vertical' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-table' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-tablet' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-tablet-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-tablet-landscape' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-tablet-landscape-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-tags' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-tags-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-taxi-front' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-taxi-front-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-telegram' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-telephone' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-telephone-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-telephone-forward' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-telephone-forward-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-telephone-inbound' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-telephone-inbound-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-telephone-minus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-telephone-minus-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-telephone-outbound' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-telephone-outbound-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-telephone-plus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-telephone-plus-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-telephone-x' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-telephone-x-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-tencent-qq' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-terminal' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-terminal-dash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-terminal-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-terminal-plus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-terminal-split' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-terminal-x' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-text-center' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-text-indent-left' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-text-indent-right' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-text-left' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-text-paragraph' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-text-right' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-text-wrap' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-textarea' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-textarea-resize' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-textarea-t' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-thermometer' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-thermometer-half' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-thermometer-high' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-thermometer-low' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-thermometer-snow' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-thermometer-sun' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-threads' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-threads-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-three-dots' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-three-dots-vertical' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-thunderbolt' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-thunderbolt-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-ticket' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-ticket-detailed' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-ticket-detailed-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-ticket-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-ticket-perforated' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-ticket-perforated-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-tiktok' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-toggle-off' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-toggle-on' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-toggle2-off' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-toggle2-on' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-toggles' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-toggles2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-tools' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-tornado' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-train-freight-front' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-train-freight-front-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-train-front' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-train-front-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-train-lightrail-front' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-train-lightrail-front-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-translate' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-transparency' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-trash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-trash-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-trash2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-trash2-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-trash3' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-trash3-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-tree' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-tree-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-trello' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-triangle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-triangle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-triangle-half' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-trophy' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-trophy-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-tropical-storm' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-truck' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-truck-flatbed' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-truck-front' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-truck-front-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-tsunami' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-twitch' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-twitter' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-twitter-x' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-type' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-type-bold' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-type-h1' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-type-h2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-type-h3' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-type-h4' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-type-h5' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-type-h6' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-type-italic' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-type-strikethrough' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-type-underline' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-typescript' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-ubuntu' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-ui-checks' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-ui-checks-grid' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-ui-radios' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-ui-radios-grid' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-umbrella' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-umbrella-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-unindent' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-union' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-unity' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-universal-access' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-universal-access-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-unlock' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-unlock-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-unlock2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-unlock2-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-upload' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-usb-c-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-usb-drive' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-usb-drive-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-usb-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-usb-micro' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-usb-micro-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-usb-mini' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-usb-mini-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-usb-plug' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-usb-plug-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-usb-symbol' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-valentine' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-valentine2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-vector-pen' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-view-list' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-view-stacked' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-vignette' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-vimeo' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-vinyl' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-vinyl-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-virus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-virus2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-voicemail' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-volume-down' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-volume-down-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-volume-mute' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-volume-mute-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-volume-off' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-volume-off-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-volume-up' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-volume-up-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-wallet-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-wallet2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-watch' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-water' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-webcam' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-webcam-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-wechat' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-whatsapp' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-wifi' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-wifi-1' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-wifi-2' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-wifi-off' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-wikipedia' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-wind' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-window' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-window-dash' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-window-desktop' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-window-dock' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-window-fullscreen' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-window-plus' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-window-sidebar' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-window-split' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-window-stack' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-window-x' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-windows' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-wordpress' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-wrench' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-wrench-adjustable' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-wrench-adjustable-circle' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-wrench-adjustable-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-x-circle-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-x-diamond' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-x-diamond-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-x-lg' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-x-octagon' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-x-octagon-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-x-square' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-x-square-fill' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-xbox' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-yelp' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-yin-yang' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-youtube' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-zoom-in' ? 'selected' : '' }}"
        ...
        <div class="icon-option {{ old('IconClass') == 'bi bi-zoom-out' ? 'selected' : '' }}"
