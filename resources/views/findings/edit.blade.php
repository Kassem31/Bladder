                            ...
                            <form action="{{ route('findings.update', $finding) }}" method="POST" class="row g-3">
                                ...
                                @method('PUT') <div class="col-md-6">
                                    ...
                                    <div class="icon-select-container">
                                        ...
                                        <div class="icon-select-dropdown" id="iconSelectDropdown">
                                            ...
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-address-book' ? 'selected' : '' }}"
                                                data-value="far fa-address-book">
                                                <i class="far fa-address-book"
                                                    style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-bell' ? 'selected' : '' }}"
                                                data-value="far fa-bell">
                                                <i class="far fa-bell" style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-bookmark' ? 'selected' : '' }}"
                                                data-value="far fa-bookmark">
                                                <i class="far fa-bookmark" style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-calendar' ? 'selected' : '' }}"
                                                data-value="far fa-calendar">
                                                <i class="far fa-calendar" style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-chart-bar' ? 'selected' : '' }}"
                                                data-value="far fa-chart-bar">
                                                <i class="far fa-chart-bar" style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-clipboard' ? 'selected' : '' }}"
                                                data-value="far fa-clipboard">
                                                <i class="far fa-clipboard" style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-clone' ? 'selected' : '' }}"
                                                data-value="far fa-clone">
                                                <i class="far fa-clone" style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-comment-dots' ? 'selected' : '' }}"
                                                data-value="far fa-comment-dots">
                                                <i class="far fa-comment-dots"
                                                    style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-compass' ? 'selected' : '' }}"
                                                data-value="far fa-compass">
                                                <i class="far fa-compass" style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-copy' ? 'selected' : '' }}"
                                                data-value="far fa-copy">
                                                <i class="far fa-copy" style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-edit' ? 'selected' : '' }}"
                                                data-value="far fa-edit">
                                                <i class="far fa-edit" style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-envelope' ? 'selected' : '' }}"
                                                data-value="far fa-envelope">
                                                <i class="far fa-envelope" style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-eye' ? 'selected' : '' }}"
                                                data-value="far fa-eye">
                                                <i class="far fa-eye" style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-file' ? 'selected' : '' }}"
                                                data-value="far fa-file">
                                                <i class="far fa-file" style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-flag' ? 'selected' : '' }}"
                                                data-value="far fa-flag">
                                                <i class="far fa-flag" style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-folder' ? 'selected' : '' }}"
                                                data-value="far fa-folder">
                                                <i class="far fa-folder" style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-gem' ? 'selected' : '' }}"
                                                data-value="far fa-gem">
                                                <i class="far fa-gem" style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-heart' ? 'selected' : '' }}"
                                                data-value="far fa-heart">
                                                <i class="far fa-heart" style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-image' ? 'selected' : '' }}"
                                                data-value="far fa-image">
                                                <i class="far fa-image" style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-map' ? 'selected' : '' }}"
                                                data-value="far fa-map">
                                                <i class="far fa-map" style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-paper-plane' ? 'selected' : '' }}"
                                                data-value="far fa-paper-plane">
                                                <i class="far fa-paper-plane"
                                                    style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-save' ? 'selected' : '' }}"
                                                data-value="far fa-save">
                                                <i class="far fa-save" style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-smile' ? 'selected' : '' }}"
                                                data-value="far fa-smile">
                                                <i class="far fa-smile" style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-star' ? 'selected' : '' }}"
                                                data-value="far fa-star">
                                                <i class="far fa-star" style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-sticky-note' ? 'selected' : '' }}"
                                                data-value="far fa-sticky-note">
                                                <i class="far fa-sticky-note"
                                                    style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-times-circle' ? 'selected' : '' }}"
                                                data-value="far fa-times-circle">
                                                <i class="far fa-times-circle"
                                                    style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-user' ? 'selected' : '' }}"
                                                data-value="far fa-user">
                                                <i class="far fa-user" style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-trash-alt' ? 'selected' : '' }}"
                                                data-value="far fa-trash-alt">
                                                <i class="far fa-trash-alt"
                                                    style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-registered' ? 'selected' : '' }}"
                                                data-value="far fa-registered">
                                                <i class="far fa-registered"
                                                    style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-keyboard' ? 'selected' : '' }}"
                                                data-value="far fa-keyboard">
                                                <i class="far fa-keyboard" style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-hourglass' ? 'selected' : '' }}"
                                                data-value="far fa-hourglass">
                                                <i class="far fa-hourglass"
                                                    style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-dot-circle' ? 'selected' : '' }}"
                                                data-value="far fa-dot-circle">
                                                <i class="far fa-dot-circle"
                                                    style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-copyright' ? 'selected' : '' }}"
                                                data-value="far fa-copyright">
                                                <i class="far fa-copyright"
                                                    style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-clock' ? 'selected' : '' }}"
                                                data-value="far fa-clock">
                                                <i class="far fa-clock" style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-building' ? 'selected' : '' }}"
                                                data-value="far fa-building">
                                                <i class="far fa-building" style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-file-code' ? 'selected' : '' }}"
                                                data-value="far fa-file-code">
                                                <i class="far fa-file-code"
                                                    style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-hdd' ? 'selected' : '' }}"
                                                data-value="far fa-hdd">
                                                <i class="far fa-hdd" style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-life-ring' ? 'selected' : '' }}"
                                                data-value="far fa-life-ring">
                                                <i class="far fa-life-ring"
                                                    style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-money-bill-alt' ? 'selected' : '' }}"
                                                data-value="far fa-money-bill-alt">
                                                <i class="far fa-money-bill-alt"
                                                    style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-lightbulb' ? 'selected' : '' }}"
                                                data-value="far fa-lightbulb">
                                                <i class="far fa-lightbulb"
                                                    style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-question-circle' ? 'selected' : '' }}"
                                                data-value="far fa-question-circle">
                                                <i class="far fa-question-circle"
                                                    style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-square' ? 'selected' : '' }}"
                                                data-value="far fa-square">
                                                <i class="far fa-square" style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-list-alt' ? 'selected' : '' }}"
                                                data-value="far fa-list-alt">
                                                <i class="far fa-list-alt" style="font-size: 1.2rem; color: #0d6efd;"></i>
                                            </div>
                                            <div class="icon-option {{ old('IconClass', $finding->IconClass) == 'far fa-thumbs-up' ? 'selected' : '' }}"
                                ...
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary px-5">
                                        <i class="bx bx-save me-1"></i>Update Finding
                                    </button>
