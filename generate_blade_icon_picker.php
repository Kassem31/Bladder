...
$outputFile = 'blade_icon_picker.blade.php';
...
echo "Generating Blade-compatible icon picker for $totalIcons Bootstrap icons...\n";

$bladeHtml = '';

// Generate the icon picker dropdown structure compatible with Laravel Blade
...
foreach ($icons as $icon) {
    ...
    $bladeHtml .= '        <div class="icon-option {{ old(\'IconClass\') == \'' . $iconClass . '\' ? \'selected\' : \'\' }}"' . "\n";
...
echo "Blade-compatible icon picker generated and saved to $outputFile\n";
